        ...
        switch(id) {
            ...
            case 1:
                try {
                    ...
                    //departure = NormalTruncated(10, 2.5, 5, 80);
                    return departure;
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            case 4:
                try {
                    ...
                    //departure = NormalTruncated(50, 10, 2, 60);
                    return departure;
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            case 5:
                try {
                    ...
                    //departure = NormalTruncated(50, 10, 10, 60);
                    return departure;
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            case 6:
                try {
                    ...
                    //departure = NormalTruncated(3.25, 1, 2, 18);
                    return departure;
                } catch (Exception e) {
                    e.printStackTrace();
                }
